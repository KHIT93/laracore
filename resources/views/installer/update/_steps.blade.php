...
@if(Request::path() == 'installer/license')
    <li class="bg-success disabled"><a>{{ trans('installer.welcome.header') }}</a></li>
...
@if(Request::path() == 'installer/requirements')
    <li class="bg-success disabled"><a>{{ trans('installer.welcome.header') }}</a></li>
    <li class="bg-success disabled"><a>{!! FA::icon('gavel') !!} {{ trans('installer.license.header') }}</a></li>
...
@if(Request::path() == 'installer/database')
    <li class="bg-success disabled"><a>{{ trans('installer.welcome.header') }}</a></li>
    <li class="bg-success disabled"><a>{!! FA::icon('gavel') !!} {{ trans('installer.license.header') }}</a></li>
    <li class="bg-success disabled"><a>{!! FA::icon('check') !!} {{ trans('installer.requirements.header') }}</a> </li>
...
@if(Request::path() == 'installer/site')
    ...
    <li class="bg-success disabled"><a>{!! FA::icon('gavel') !!} {{ trans('installer.license.header') }}</a></li>
    <li class="bg-success disabled"><a>{!! FA::icon('check') !!} {{ trans('installer.requirements.header') }}</a> </li>
    <li class="bg-success disabled"><a>{!! FA::icon('database') !!} {{ trans('installer.database.header') }}</a></li>
...
@if(Request::path() == 'installer/run')
    ...
    <li class="bg-success disabled"><a>{!! FA::icon('check') !!} {{ trans('installer.requirements.header') }}</a> </li>
    <li class="bg-success disabled"><a>{!! FA::icon('database') !!} {{ trans('installer.database.header') }}</a></li>
    <li class="bg-success disabled"><a>{!! FA::icon('wrench') !!} {{ trans('installer.site.header') }}</a></li>
...
@if(Request::path() == 'installer/finish')
    ...
    <li class="bg-success disabled"><a>{!! FA::icon('database') !!} {{ trans('installer.database.header') }}</a></li>
    <li class="bg-success disabled"><a>{!! FA::icon('wrench') !!} {{ trans('installer.site.header') }}</a></li>
    <li class="bg-success disabled"><a>@if(Request::path() == 'installer/run') <i class="fa fa-circle-o-notch fa-spin"></i> @else {!! FA::icon('tasks') !!} @endif {{ trans('installer.install') }}</a></li>
